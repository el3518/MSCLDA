...
class MDAnet(nn.Module):
    ...
    def forward(self, data_src1, data_src2=0, data_tgt = 0, label_src = 0, mark = 1):
        com_loss = 0
        div_loss = 0
        st_loss = 0
